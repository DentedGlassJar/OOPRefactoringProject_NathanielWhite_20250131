...
{
    public override string GetCardDescription(string cardName)
    {
        return "Fireball (Costs 30 mana): Deal 40 damage";
    }
...
/* Things needed to do:
 * Create an abstract Card base class with appropriate shared properties and methods (1 pt)
 * Implement all 5 specific card classes (FireballCard, IceShieldCard, etc.) inheriting from the base (1.5 pts)
 * Use abstract/virtual methods for card effects (1 pt)
 * 
 * Create Player/Character class to encapsulate health, mana, shields, and buffs (1 pt)
 * Implement appropriate properties with good encapsulation (and with validation where needed) (1 pt)
 * 
 * Separate card logic from main game loop (1 pt)
 * Create separate methods for different game functionalities (drawing cards, playing cards, updating state) (1 pt)
 * 
 * Organize code into appropriate classes (0.5pts)
 * Add comments in the code explaining your decisions regarding the refactoring (0.5pts)
 * 
 * 
 *  Add one new card type with unique effects (1.5 pts)
 */
